  ...
  return (
    <div className="w-full flex flex-col justify-between items-center mt-[56px]">
      ...
      {id === 0 ? (
        ...
        <button
          type="button"
          className="w-full rounded-xl min-h-[56px] text-[16px] font-bold text-Dark-Brown border-[1px] bord er-Dark-Brown hover:bg-Dark-Brown hover:text-white absolute bottom-[64px] animate-fade"
          onClick={handlePrev}
        >
          이전
        </button>
